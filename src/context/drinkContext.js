...
export const DrinkContextProvider = ({ children }) => {
  ...
  const createUserDrink = async (
    ...
    try {
      ...
      console.error("Error in createUserDrink: ", error.message);
  ...
  const updateUserDrink = async (
    ...
    try {
      ...
      console.error("Error in updateUserDrink: ", error.message);
      return { success: false, message: error.message };
    } finally {
  ...
  const deleteUserDrink = async (drinkId) => {
    ...
    try {
      ...
      console.error("Error in deleteUserDrink: ", error.message);
      return { success: false, message: error.message };
    } finally {
  ...
  const addSessionDrinkToCurrentSessions = async (drinkId, drankAt) => {
    ...
    try {
      ...
      console.error("Error in addSessionDrinkToCurrentSessions: ", error.message);
      return { success: false, message: error.message };
    } finally {
      setAddDrinkLoading(false);
    }
  };

  const addSessionDrinkToCurrentSession = async (drinkId, sessionId, drankAt) => {
    try {
      setAddDrinkLoading(true);
      if (drankAt > new Date())
        return {
      ...
      console.error("Error in addSessionDrinkToCurrentSession: ", error.message);
      return { success: false, message: error.message };
    } finally {
      setAddDrinkLoading(false);
    }
  ...
  const createSessionDrink = async (
    ...
    try {
      ...
      console.error("Error in createSessionDrink: ", error.message);
      return { success: false, message: error.message };
    } finally {
      setCreateDrinkLoading(false);
    }
  ...
  const updateSessionDrink = async (
    ...
    try {
      ...
      console.error("Error in updateSessionDrink: ", error.message);
      return { success: false, message: error.message };
    } finally {
      setUpdateDrinkLoading(false);
    }
  ...
  const deleteSessionDrink = async (sessionId, drinkId) => {
    ...
    try {
      ...
      console.error("Error in deleteSessionDrink: ", error.message);
      return { success: false, message: error.message };
    } finally {
      setDeleteDrinkLoading(false);
    }
